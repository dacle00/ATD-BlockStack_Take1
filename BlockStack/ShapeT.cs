...
namespace BlockStack
{
    class ShapeT : Tetromino
    {
        ...
        public override void constructPiece(Microsoft.Xna.Framework.Color tint, int width, int hight, Microsoft.Xna.Framework.Graphics.Texture2D texture)
        {
            ...
            up.Add(new Block(new Vector2(2f, 2f), tint, width, hight, texture));

            left.Add(new Block(new Vector2(2f, 0f), tint, width, hight, texture));
            left.Add(new Block(new Vector2(3f, 1f), tint, width, hight, texture));
            ...
            down.Add(new Block(new Vector2(2f, 0f), tint, width, hight, texture));

            right.Add(new Block(new Vector2(2f, 0f), tint, width, hight, texture));
            right.Add(new Block(new Vector2(1f, 1f), tint, width, hight, texture));
