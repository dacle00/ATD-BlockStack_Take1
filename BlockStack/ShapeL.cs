///////////////////////////////////////////////////////////////////////////////////////////
// ShapeL class is a data type for a tetromino piece
//
...
namespace BlockStack
{
    class ShapeL : Tetromino
    {
        ...
        public override void constructPiece(Microsoft.Xna.Framework.Color tint, int width, Microsoft.Xna.Framework.Graphics.Texture2D texture)
        {
            ...
            up.Add(new Block(new Vector2(1f, 2f), tint, width, texture));
            ...
            left.Add(new Block(new Vector2(3f, 2f), tint, width, texture));

            // Down
            down.Add(new Block(new Vector2(3f, 0f), tint, width, texture));
            ...
            // Right
            right.Add(new Block(new Vector2(1f, 0f), tint, width, texture));
